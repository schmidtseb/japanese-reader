// src/features/Review/ChunkCompleteScreen.tsx
...
export const ChunkCompleteScreen = ({ onContinue, onExit, hasMoreChunks, hasReviews }: ChunkCompleteScreenProps) => {
    let buttonText = "Finish Session";
    if (hasMoreChunks) {
        buttonText = "Next Chunk";
    } else if (hasReviews) {
    ...
    return (
        <div className="text-center py-16 px-6 max-w-lg mx-auto flex flex-col h-full justify-center">
            ...
            <h2 className="text-2xl font-bold text-text-primary">Chunk Complete!</h2>
            <p className="mt-2 text-text-secondary">Great work! You've learned this set of items.</p>
